...
const placements = {
  ...
  E: { graphic: 'E', bgColor: '#6ECAFF', cells: ['R1C4', 'R2C8', 'R3C6', 'R3C11', 'R4C2', 'R4C12'] },
  R: { graphic: 'R', bgColor: '#A58AE8', cells: ['R1C2', 'R2C10', 'R3C7'] },
}
...
const textBlocks = [
  {
    ...
    col: 1,
    align: 'left-bottom',
    lines: ['welcome to upper.website'],
  },
  {
    key: 'experience',
    row: 2,
